...
CPPUNIT_TEST_FIXTURE(TestCompileDiff, testStandaloneLoweringOperatorTokenParitySmoke)
{
    ...
    const struct
    {
        ...
        { u"if_function", u"=IF(A1;B1;C1)" },
        { u"ifna_function", u"=IFNA(A1;0)" },
        { u"false_function", u"=FALSE()" },
        { u"pi_function", u"=PI()" },
        { u"xor_function", u"=XOR(0;0)" },
        { u"today_function", u"=TODAY()" },
        { u"acot_function", u"=ACOT(0)/PI()" },
        { u"degrees_function", u"=DEGREES(1)" },
        { u"and_function", u"=AND(A1;B1)" },
        { u"iserror_function", u"=ISERROR(A1/0)" },
        { u"isblank_function", u"=ISBLANK(A1)" },
        { u"iseven_function", u"=ISEVEN(0)" },
        { u"isodd_function", u"=ISODD(0)" },
        { u"n_function", u"=N(A1)" },
        { u"atanh_function", u"=ATANH(0)/PI()" },
        { u"upper_function", u"=UPPER(\"a\")" },
        { u"lower_function", u"=LOWER(\"A\")" },
        { u"len_function", u"=LEN(\"abc\")" },
        { u"t_function", u"=T(J1:J10)" },
        { u"round_function", u"=ROUND(1.234;2)" },
        { u"roundup_function", u"=ROUNDUP(1.234;2)" },
        { u"rounddown_function", u"=ROUNDDOWN(1.234;2)" },
        { u"ceiling_function", u"=CEILING(-11;-2)" },
        { u"floor_function", u"=FLOOR(-11;-2)" },
        { u"gcd_function", u"=GCD(16;32;24)" },
        { u"lcm_function", u"=LCM(16;32;24)" },
        { u"log_function", u"=LOG(10;3)" },
        { u"max_function", u"=MAX(A1;B1)" },
        { u"mod_function", u"=MOD(5;2)" },
        { u"value_function", u"=VALUE(\"42\")" },
        { u"timevalue_function", u"=TIMEVALUE(\"1:23 PM\")" },
        { u"date_function", u"=DATE(2015;1;11)" },
        { u"time_function", u"=TIME(1;23;0)" },
        { u"days360_function", u"=DAYS360(G1;G2)" },
        { u"networkdays_function", u"=NETWORKDAYS(K2;K3;K4:K6)" },
        { u"networkdays_intl_function", u"=NETWORKDAYS.INTL(K2;K3;;K4:K6)" },
        { u"weeknum_function", u"=WEEKNUM(\"2000-06-14\")" },
        { u"weekday_function", u"=WEEKDAY(\"2000-06-14\")" },
        { u"datedif_function", u"=DATEDIF(K2;L2;K1)" },
        { u"indirect_function", u"=INDIRECT(\"A1\")" },
        { u"match_function", u"=MATCH(\"a\";A1:A3;0)" },
        { u"sumif_function", u"=SUMIF(A1:A5;\"unpaid\";B1:B5)" },
        { u"address_function", u"=ADDRESS(1;1;2;;\"Sheet2\")" },
        { u"true_function", u"=TRUE()" },
        { u"na_function", u"=NA()" },
        { u"isna_function", u"=ISNA(A1)" },
        { u"clean_function", u"=CLEAN(\"A\")" },
        { u"char_function", u"=CHAR(65)" },
        { u"code_function", u"=CODE(\"A\")" },
        { u"jis_function", u"=JIS(\"Libre Office\")" },
        { u"asc_function", u"=ASC(\"Libre Office\")" },
        { u"unichar_function", u"=UNICHAR(65)" },
        { u"exact_function", u"=EXACT(\"A\";\"a\")" },
        { u"hlookup_function", u"=HLOOKUP(\"Cat\";A1:B2;2;0)" },
        { u"lookup_function", u"=LOOKUP(2;A1:A2;B1:B2)" },
        { u"columns_function", u"=COLUMNS(A1:B2)" },
        { u"offset_function", u"=OFFSET(A1;2;5)" },
        { u"areas_function", u"=AREAS(A1:B2)" },
        { u"replace_function", u"=REPLACE(\"1234567\";1;1;\"444\")" },
        { u"replaceb_function", u"=REPLACEB(K1;K2;L2;\"ab\")" },
        { u"left_function", u"=LEFT(\"abcd\";2)" },
        { u"right_function", u"=RIGHT(\"abc\";2)" },
        { u"search_function", u"=SEARCH(54;998877665544)" },
        { u"mid_function", u"=MID(\"abc\";2;1)" },
        { u"text_function", u"=TEXT(12.34567;\"###.##\")" },
        { u"concatenate_function", u"=CONCATENATE(\"a\";\"b\")" },
        { u"mmult_function", u"=MMULT(A1:B2;C1:D2)" },
        { u"convert_ooo_function", u"=ORG.OPENOFFICE.CONVERT(100;\"ATS\";\"EUR\")" },
        { u"convert_function", u"=CONVERT(1;\"m\";\"cm\")" },
        { u"dec2hex_function", u"=DEC2HEX(10)" },
        { u"mround_function", u"=MROUND(10;3)" },
        { u"multinomial_function", u"=MULTINOMIAL(1;2;3)" },
        { u"yearfrac_function", u"=YEARFRAC(DATE(2014;1;1);DATE(2015;1;1);0)" },
        { u"base_function", u"=BASE(17;10;4)" },
        { u"decimal_function", u"=DECIMAL(\"10\";2)" },
        { u"getpivotdata_function", u"=GETPIVOTDATA(\"quantity\";M1)" },
        { u"euroconvert_function", u"=EUROCONVERT(100;\"ATS\";\"EUR\")" },
        { u"hyperlink_function", u"=HYPERLINK(\"http://www.example.com\";\"Hyperlink\")" },
        { u"lenb_function", u"=LENB(\"abc\")" },
        { u"findb_function", u"=FINDB(\"cd\";\"abcdefg\";1)" },
