...
- [COMPUTATIONAL_SUBSTRATE_INTERPRET_TAIL_CAPABILITY_CLUSTER_EXPANSION_PLAN.md](COMPUTATIONAL_SUBSTRATE_INTERPRET_TAIL_CAPABILITY_CLUSTER_EXPANSION_PLAN.md):
  active ambitious next-wave plan for expanding the live `InterpretTail`
  delegation seam by host-backed capability cluster
...
5. [COMPUTATIONAL_SUBSTRATE_INTERPRET_TAIL_ENGINE_EVALUATOR_SWITCHOVER_DECISION_RECORD.md](COMPUTATIONAL_SUBSTRATE_INTERPRET_TAIL_ENGINE_EVALUATOR_SWITCHOVER_DECISION_RECORD.md)
6. [../PROJECT_STATUS.md](../PROJECT_STATUS.md)
7. individual historical `COMPUTATIONAL_SUB*.md` files only as needed
