...
4. [COMPUTATIONAL_SUBSTRATE_INTERPRET_TAIL_ENGINE_EVALUATOR_SWITCHOVER_DECISION_RECORD.md](COMPUTATIONAL_SUBSTRATE_INTERPRET_TAIL_ENGINE_EVALUATOR_SWITCHOVER_DECISION_RECORD.md)
5. [../PROJECT_STATUS.md](../PROJECT_STATUS.md)
6. individual historical `COMPUTATIONAL_SUB*.md` files only as needed
