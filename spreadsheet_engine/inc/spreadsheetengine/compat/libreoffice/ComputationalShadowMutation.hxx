...
[[nodiscard]] inline spreadsheetengine::detail::substrate::ShadowMutationState
rebuildComputationalShadowAfterMutation(
    ...
    const spreadsheetengine::detail::facade::MutationEvent& rMutation)
{
    ...
    return spreadsheetengine::detail::substrate::rebuildComputationalShadowAfterMutation(
